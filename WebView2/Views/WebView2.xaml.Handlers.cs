...
namespace WebView2Browser
{
    public partial class MainWindow
    {
        ...
        {
            if (_isInitialized && WebViewControl.CoreWebView2.CanGoBack) NavigationHandler.GoBack();
        }
        private async void ForwardButton_Click(object sender, RoutedEventArgs e)
        {
            if (_isInitialized && WebViewControl.CoreWebView2.CanGoForward) NavigationHandler.GoForward();
        }
        private async void RefreshButton_Click(object sender, RoutedEventArgs e)
        {
            if (_isInitialized) NavigationHandler.Refresh();
        }
        private async void HomeButton_Click(object sender, RoutedEventArgs e)
        {
            if (_isInitialized) await NavigationHandler.NavigateToAddressAsync("about:blank");
        }
        ...
        {
            if (e.Key == Key.Enter) await NavigationHandler.NavigateToAddressAsync();
        }
        private async void StopButton_Click(object sender, RoutedEventArgs e)
        {
            if (_isInitialized) { WebViewControl.CoreWebView2.Stop(); StatusText.Text = "Loading stopped"; }
        }
        ...
        {
            if (e.Key == Key.Enter) await FindAsync("start", FindBox.Text);
        }
