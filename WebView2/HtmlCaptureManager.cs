...
namespace WebView2Browser
{
    ...
    {
        private readonly HtmlCaptureService _htmlCaptureService;
        private readonly WebViewNavigationHandler _navigationHandler;
        ...
        public HtmlCaptureManager(HtmlCaptureService htmlCaptureService, WebViewNavigationHandler navigationHandler, string linksSavePath)
        {
