...
namespace Mp3MetadataViewer
{
    public partial class MainWindow : Window
    {
        ...
        private void ScanButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var shuffledIds = Enumerable.Range(1, mp3Files.Length).OrderBy(x => random.Next()).ToList();
                ...
                for (int i = 0; i < mp3Files.Length; i++)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Index = i + 1,                      // Sequential index (1-based)
                            RandomId = shuffledIds[i],          // Random ID from shuffled list
        ...
        private void ExportButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    // Add header row
                    csvContent.AppendLine("Index,RandomId,FileName,FileSize,Title,Artist,Album,Year,Track,Genre,Duration,Seconds,Bitrate,BPM");
    ...
    {
        public int Index { get; set; }      // Sequential index (1 to N)
        public int RandomId { get; set; }   // Random ID (1 to N, shuffled)
